...
lv_obj_align_to(ui_Label2,ui_Image2,LV_ALIGN_OUT_RIGHT_MID,0,-3);
...
lv_label_set_text(ui_Label3,"Sunday 2023/11/26");
...
lv_obj_align_to(ui_Label16,ui_Label5,LV_ALIGN_OUT_RIGHT_MID,0,0);
lv_label_set_text(ui_Label16," Km/h");
